...
$query_AdminLogin = "SELECT * FROM main";
$AdminLogin = mysql_query($query_AdminLogin, $localhost) or die(mysql_error());
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <title>www.uSE.co.ke/Admin Login</title>
